-- ------------------------------------------------------------------------------
--                     Author    : FIS - JPD
--                     Time-stamp: "2021-04-12 08:01:46 jpdur"
-- ------------------------------------------------------------------------------
...
BEGIN
	 ...
	 from #ListNodesNames
      ...
      on x.Description = KCNA.Description
      when matched AND KCNA.KPICompanyTemplateID = @KPICompanyTemplateID and KCNA.KPITypeID = @HierarchyID then
